...
export default function Home() {
  ...
  window.electron.ipcRenderer.once('ipc-get-app-version', (arg: string) => {
    setAppVer(arg);
  });

  window.electron.ipcRenderer.getAppVersion();
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 25, marginBottom: 25 }}>
            <List horizontal relaxed>
              ...
              <List.Item>
                <a
                  href="https://github.com/hiql/mytools-desktop"
                  target="_blank"
                  title="Visit Github"
                  rel="noreferrer"
                >
